...
async function main() {
  ...
  try {
    // 1. 국가 데이터 (Countries)
    const countriesData = [
      { code: 'ALL', name: '전체 공통 🌐', nameEn: 'All Countries', emoji: '🌐', plug: '공통', visa: '해당없음', currency: '공통', currencyCode: 'ALL' },
      { code: 'JP', name: '일본', nameEn: 'Japan', emoji: '🇯🇵', plug: '110V', visa: '무비자 90일', currency: '엔 (JPY)', currencyCode: 'JPY' },
      { code: 'VN', name: '베트남', nameEn: 'Vietnam', emoji: '🇻🇳', plug: '220V', visa: '무비자 45일', currency: '동 (VND)', currencyCode: 'VND' },
      { code: 'TH', name: '태국', nameEn: 'Thailand', emoji: '🇹🇭', plug: '220V / 겸용', visa: '무비자 90일', currency: '바트 (THB)', currencyCode: 'THB' },
      { code: 'SG', name: '싱가포르', nameEn: 'Singapore', emoji: '🇸🇬', plug: '230V / 어댑터', visa: '무비자 90일', currency: '싱가포르 달러 (SGD)', currencyCode: 'SGD' },
      { code: 'PH', name: '필리핀', nameEn: 'Philippines', emoji: '🇵🇭', plug: '220V / 110V', visa: '무비자 30일', currency: '페소 (PHP)', currencyCode: 'PHP' },
      { code: 'TW', name: '대만', nameEn: 'Taiwan', emoji: '🇹🇼', plug: '110V', visa: '무비자 90일', currency: '대만 달러 (TWD)', currencyCode: 'TWD' },
      { code: 'US', name: '미국', nameEn: 'United States', emoji: '🇺🇸', plug: '110V', visa: 'ESTA 전자비자', currency: '달러 (USD)', currencyCode: 'USD' },
      { code: 'FR', name: '프랑스', nameEn: 'France', emoji: '🇫🇷', plug: '230V', visa: '무비자 90일', currency: '유로 (EUR)', currencyCode: 'EUR' },
      { code: 'IT', name: '이탈리아', nameEn: 'Italy', emoji: '🇮🇹', plug: '230V', visa: '무비자 90일', currency: '유로 (EUR)', currencyCode: 'EUR' },
      { code: 'KR', name: '대한민국', nameEn: 'South Korea', emoji: '🇰🇷', plug: '220V', visa: '내국인', currency: '원 (KRW)', currencyCode: 'KRW' },
    ];
    ...
    console.log('✅ 1/4 국가(Countries) 10개국 및 메타데이터 적재 완료');
    ...
    const countryGuidesData = [
      ...
      },
      {
        ...
        description: '일본은 110V 전압을 사용하므로 한국 전자기기 사용을 위한 돼지코 어댑터가 필수입니다.',
        icon: '🔌',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      },
      {
        ...
        description: '일본은 1엔, 5엔, 10엔, 50엔, 100엔, 500엔 등 동전 쓰임새가 많으므로 동전 지갑이 매우 편리합니다.',
        icon: '🪙',
        isRequired: false,
        isCheckable: true,
        sortOrder: 2,
      ...
      // 🇻🇳 베트남 (VN)
      {
        ...
        countryCode: 'VN',
        category: 'pre_travel',
        title: '베트남 무비자 45일 입국 조건 & 출국 항공권 e-티켓 지참',
        description: '대한민국 국민은 무비자로 최대 45일까지 베트남 체류가 가능합니다. 입국 심사 시 출국 e-티켓을 제시하지 못하면 탑승이 거절될 수 있습니다.',
        icon: '🛂',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      },
      {
        ...
        countryCode: 'VN',
        category: 'pre_travel',
        title: 'Grab (그랩) 차량 호출 앱 사전 설치 및 카드 연동',
        description: '베트남 공항 및 길거리 택시의 미터기 사기나 바가지요금을 방지하려면 미리 Grab 앱을 다운로드하고 신용카드를 연동하세요.',
        icon: '🚕',
        isRequired: true,
        isCheckable: true,
        sortOrder: 2,
      },
      {
        ...
        countryCode: 'VN',
        category: 'essentials',
        title: '100달러(USD) 신권 지폐 & 동지갑 준비',
        description: '한국 원화를 뼛뼛한 100달러 신권으로 준비해 현지 금은방/환전소에서 베트남 동(VND)으로 우대 환전하는 것이 가장 유리합니다.',
        icon: '💵',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      },
      {
        ...
        countryCode: 'VN',
        category: 'essentials',
        title: '휴대용 샤워기 필터 & 비상약 (지사제/소화제)',
        description: '베트남 일부 호텔은 수질 문제로 피부 트러블이 발생할 수 있으므로 여행용 샤워기 필터와 물갈이 대비 지사제가 필수입니다.',
        icon: '🚿',
        isRequired: true,
        isCheckable: true,
        sortOrder: 2,
      },
      {
        ...
        countryCode: 'VN',
        category: 'baggage',
        title: '전자담배(Vape) 반입 및 소지 엄격 금지 ⚠️',
        description: '베트남은 전자담배 반입 및 소지가 법적으로 금지되어 있습니다. 적발 시 즉시 압수 및 고액 벌금이 부과됩니다.',
        icon: '🚭',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      ...
      // 🇹🇭 태국 (TH)
      {
        ...
        countryCode: 'TH',
        category: 'pre_travel',
        title: '태국 무비자 90일 입국 & 여권 잔여 유효기간 6개월 확인',
        description: '대한민국 국민은 무비자로 최대 90일까지 태국 체류가 가능합니다. 여권 유효기간이 6개월 미만이면 입국이 거절됩니다.',
        icon: '🛂',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      },
      {
        ...
        countryCode: 'TH',
        category: 'pre_travel',
        title: 'GLN 모바일 QR 스캔 결제 연동 (하나/토스/KB)',
        description: '태국은 야시장, 식당, 카페, 노점상까지 모바일 QR 스캔 결제(Scan Pay)가 99% 지원되므로 GLN 사전 연동이 매우 유리합니다.',
        icon: '📲',
        isRequired: true,
        isCheckable: true,
        sortOrder: 2,
      },
      {
        ...
        countryCode: 'TH',
        category: 'essentials',
        title: '왕궁 및 사원 방문용 복장 준비 (긴 바지 / 롱스커트)',
        description: '방콕 왕궁, 왓 아룬 등 사원 입장 시 민소매, 숄더리스, 찢어진 바지는 입장이 제한되므로 어깨와 무릎을 가리는 긴 옷을 챙기세요.',
        icon: '👗',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      ...
      // 🇸🇬 싱가포르 (SG)
      {
        ...
        countryCode: 'SG',
        category: 'pre_travel',
        title: 'SG Arrival Card (전자 입국신고서) 출국 3일 전 필수 제출',
        description: '싱가포르 입국 시 출국 3일 전부터 이민국(ICA)을 통해 SG Arrival Card를 제출해야 입국 심사가 가능합니다.',
        icon: '📝',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      },
      {
        ...
        countryCode: 'SG',
        category: 'pre_travel',
        title: '해외 컨택리스(Contactless) 결제 카드 지참 (트래블월렛 등)',
        description: '싱가포르 지하철(MRT)과 버스는 교통카드 없이 컨택리스 신용/체크카드를 바로 태그하여 편리하게 탑승 가능합니다.',
        icon: '💳',
        isRequired: true,
        isCheckable: true,
        sortOrder: 2,
      },
      {
        ...
        countryCode: 'SG',
        category: 'baggage',
        title: '껌 (Chewing Gum) 반입 및 소지 전면 금지 ⚠️',
        description: '싱가포르는 껌의 반입, 판매, 소지가 법적으로 엄격히 금지되어 있습니다. 적발 시 고액의 벌금이 부과됩니다.',
        icon: '🚫',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
