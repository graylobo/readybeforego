  ...
  try {
    ...
    const countryGuidesData = [
      ...
      // 🇹🇭 태국 (TH)
      {
        ...
        description: '현지 택시 바가지요금을 완벽히 방지하려면 출국 전 Grab과 Bolt 앱에 한국 카드를 연동해두는 것이 안전합니다.',
        icon: '🚕',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
      ...
      },
      {
        ...
        countryCode: 'TH',
        category: 'essentials',
        title: '왕궁 및 사원 복장 규정 (단정한 긴바지/긴치마)',
        description: '방콕 왕궁, 왓 아룬 등 사원 입장 시 숄더리스, 민소매, 찢어진 청바지, 슬리퍼 등은 입장이 제한됩니다.',
        icon: '👗',
        isRequired: true,
        isCheckable: true,
        sortOrder: 1,
